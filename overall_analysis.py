...
import helper
import preprocessor_o
import webbrowser

st.set_page_config(
    page_title="Overall Olympics Analysis",
    page_icon="https://www.kreedon.com/wp-content/uploads/2021/07/olympics-logo-1280x720-1.jpg",
    layout="centered",
...
df3 = pd.read_csv('Athletes_winter_games.csv')
region = pd.read_csv('regions.csv')

df = preprocessor_o.preprocess(df1, df2, df3, region)
...
st.sidebar.title('Overall Olympics Analysis')
...
with col1:
    ...
    if user_menu == "Athlete-wise Analysis":
        ...
        famous_sports = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics',
                         ...
                         'Beach Volleyball', 'Triathlon', 'Polo', 'Ice Hockey', '3x3 Basketball', 'Artistic Gymnastics',
                         'Artistic Swimming']
...
with col2:
    st.markdown('<a href="https://pankhuri1304-dashboard-dashboard-o8j3li.streamlit.app/" target="_self" style="padding: 8px 10px; background-color: white; color: Black; text-align: center; text-decoration: none; display: inline-block; border-radius: 4px; border: 1px solid black; cursor: pointer;">Home</a>', unsafe_allow_html=True)
